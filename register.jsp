...
<head>
    ...
    <style>
        ...
        .auth-card { background: #fff; padding: 2.5rem; border-radius: 15px; box-shadow: 0 10px 30px rgba(0,0,0,0.05); width: 100%; max-width: 450px; }
        ...
        .btn-primary { background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); border: none; border-radius: 8px; padding: 12px; font-weight: 600; font-size: 1.05rem; width: 100%; transition: all 0.3s ease; }
        ...
        <div class="d-flex justify-content-center">
            <div class="auth-card">
                <div class="text-center mb-4">
                    ...
                    <p class="text-muted">Join CourseUp and start learning today</p>
                </div>
                <form action="register" method="post">
                    ...
                    <div class="text-center small mt-3">
                        <span class="text-muted">Already have an account?</span> <a href="login.jsp" class="text-decoration-none fw-semibold" style="color: #764ba2;">Login here</a>
                    </div>
